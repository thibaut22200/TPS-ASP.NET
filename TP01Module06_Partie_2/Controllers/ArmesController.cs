...
namespace TP01Module06_Partie_2.Controllers
{
    public class ArmesController : Controller
    {
        ...
        {
            Arme arme = db.Armes.Find(id);
            var samouraiWithArme = db.Samourais.FirstOrDefault(s => s.Arme.Id == id);

            if(samouraiWithArme != null)
            {
                ModelState.AddModelError("alreadyUsed", $"Le samourai {samouraiWithArme.Nom} porte actuellement cette arme");
                return View(arme);
            }
